...
WHITE = [
    ...
    ("七、中继窗口入流水线托管", None),
    ("十八、方案窗口第十五任 pingxia-8a 收班盘点", None),
    ("十九、派工窗口 dispatch 第四十二任收班盘点", None),
    ("「145 行事件」四条", None),
    ...
    # 2026-08-19 夜 创始人窗口 pingxia-37(11B 归口继 pingxia-11)接班当轮登记节:与 §十/§十二 同型,
    # 非收班盘点、无「未消化摩擦→候选」锚,条目从节首起算 ⇒ start=None。开节与登记同一 commit,⛔ 再靠降级机制接。
    ("十五、创始人窗口 pingxia-37 接班当轮登记", None),
]
BLACK = [
